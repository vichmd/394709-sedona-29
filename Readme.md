...
* Студент: [Vich](https://up.htmlacademy.ru/htmlcss/29/user/394709).
* Наставник: `Екатерина Комнатная Прекрасная`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/394709-sedona-29) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
